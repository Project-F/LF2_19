define({
  bmp: {
    file: [
      {
        "file(0-99)": "sprite/weapon2.png", w: 48, h: 48, row: 10, col: 10
      }
    ],
    weapon_hp: 200,
    weapon_drop_hurt: 35,
  ...
  weapon_strength_list: {
    1: {
      entry: "normal", dvx: 2, vrest: 10, fall: 70, bdefend: 60, injury: 45, effect: 1
    },
    2: {
      entry: "jump", dvx: 7, fall: 70, vrest: 10, bdefend: 60, injury: 45, effect: 1
    },
    3: {
      entry: "run", dvx: 10, fall: 70, vrest: 10, bdefend: 60, injury: 55, effect: 1
    },
    4: {
  ...
  22: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: -6, y: 36, w: 20, h: 17, dvx: 8, fall: 20, bdefend: 16, injury: 789
      },
      {
        kind: 5, x: 28, y: 5, w: 14, h: 19, dvx: 8, fall: 20, bdefend: 16, injury: 789
      },
      {
        kind: 5, x: 13, y: 22, w: 17, h: 14, dvx: 8, fall: 20, bdefend: 16, injury: 789
      }
    ]
  },
  23: { name: "on_hand",
  ...
  24: { name: "on_hand",
    ...
    itr: {
      kind: 5, x: -12, y: 24, w: 56, h: 12, dvx: 8, fall: 20, bdefend: 16, injury: 789
    }
  },
  25: { name: "on_hand",
    ...
    itr: [
      {
        kind: 5, x: -8, y: 11, w: 29, h: 15, dvx: 8, fall: 20, bdefend: 16, injury: 789
      },
      {
  ...
  26: { name: "on_hand",
    ...
    itr: [
      ...
      {
        kind: 5, x: 0, y: -1, w: 18, h: 16, dvx: 8, fall: 20, bdefend: 16, injury: 789
      },
      {
        kind: 5, x: 12, y: 13, w: 19, h: 16, dvx: 8, fall: 20, bdefend: 16, injury: 789
      }
    ]
  },
  27: { name: "on_hand",
  ...
  40: { name: "throwing",
    ...
    itr: {
      kind: 0, x: 3, y: 4, w: 40, h: 39, dvx: 8, fall: 70, vrest: 10, bdefend: 60, injury: 55, effect: 1
    },
    bdy: {
      kind: 0, x: 3, y: 4, w: 40, h: 39
    }
  ...
  60: { name: "on_ground",
    pic: 2, state: 1003, wait: 1, next: 61, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0, sound: "1/079"
  },
  61: { name: "on_ground",
    pic: 5, state: 1003, wait: 2, next: 62, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 36, hit_a: 0, hit_d: 0, hit_j: 0
  },
  62: { name: "on_ground",
    pic: 3, state: 1003, wait: 2, next: 63, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 34, hit_a: 0, hit_d: 0, hit_j: 0, sound: "1/079"
  },
  63: { name: "on_ground",
  ...
  70: { name: "just_on_ground",
    pic: 2, state: 1003, wait: 1, next: 71, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 40, hit_a: 0, hit_d: 0, hit_j: 0, sound: "1/079",
    itr: {
  ...
  72: { name: "just_on_on_ground",
    pic: 3, state: 1003, wait: 2, next: 64, dvx: 0, dvy: 0, dvz: 0, centerx: 24, centery: 34, hit_a: 0, hit_d: 0, hit_j: 0, sound: "1/079",
    itr: {
      kind: 0, x: 1, y: 19, w: 46, h: 15, dvx: 2, fall: 40, arest: 16, bdefend: 16
    }
  },
