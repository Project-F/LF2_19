define({
  bmp: {
    file: [
      {
        "file(0-7)": "sprite/justin_ball.png", w: 81, h: 82, row: 4, col: 2
      }
    ],
  ...
  0: { name: "flying",
    ...
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 70, vrest: 10, bdefend: 16, injury: 40
    },
    bdy: {
  ...
  1: { name: "flying",
    pic: 1, state: 3000, wait: 1, next: 999, dvx: 15, dvy: 0, centerx: 35, centery: 41, hit_a: 50, hit_d: 40, hit_j: 0,
    itr: {
      kind: 0, x: 22, y: 27, w: 55, h: 27, dvx: 16, fall: 70, vrest: 10, bdefend: 16, injury: 40
    },
    bdy: {
